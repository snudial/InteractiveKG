...
class ControllerInterface(ABC):
    ...
    def _invoke_tool_with_retry(self, selected_tool, tool_args):
        ...
        try:
            ...
            retry_conditions = retry_if_exception_type(httpx.ReadTimeout) | retry_if_exception_type(httpx.ConnectTimeout)
            if WIKIPEDIA_AVAILABLE and wikipedia is not None:
                retry_conditions = retry_conditions | retry_if_exception_type(wikipedia.exceptions.WikipediaException)
            ...
            for attempt in Retrying(
                ...
                with attempt:
                    try:
                        ...
                        if WIKIPEDIA_AVAILABLE and wikipedia is not None:
                            try:
                                if isinstance(e, wikipedia.exceptions.WikipediaException):
