...
def main():
    ...
    if args.benchmark == "all" or args.benchmark == "gaia":
        ...
        shutil.copytree(data_dir, attachments_dir, dirs_exist_ok=True)
        shutil.copytree(data_dir, python_container_attachments_dir, dirs_exist_ok=True)
